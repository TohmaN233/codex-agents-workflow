...
import { waitForManagedLogin } from '../../plugins/codex-agents-workflow/control-plane/lib/execution/codex-managed-login.mjs';
...
report.auth_wait_sha256 = digest(await readFile(fileURLToPath(new URL('../../plugins/codex-agents-workflow/control-plane/lib/execution/codex-managed-login.mjs', import.meta.url))));

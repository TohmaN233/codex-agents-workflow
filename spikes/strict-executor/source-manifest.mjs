...
export const SOURCES = [
  'source-manifest.mjs',
  ...['codex-app-server-client', 'codex-profile-builder', 'codex-process-ownership', 'codex-session', 'codex-skill-policy', 'codex-tool-broker'].map(name => `../../plugins/codex-agents-workflow/control-plane/lib/execution/${name}.mjs`),
  ...['workflow-revisions', 'workflow-paths', 'workflow-events', 'workflow-bindings'].map(name => `../../plugins/codex-agents-workflow/control-plane/lib/${name}.mjs`),

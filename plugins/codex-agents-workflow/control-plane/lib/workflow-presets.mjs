...
function mathematicalResearchHybrid(preset,providers,routingRules) {
  ...
  const final=mainAgent('final','Main agent · accept research outcome',
    ...
    {task:'/inputs/task',decision:'/nodes/choose_research_mode/output',human_confirmation:'/nodes/confirm_persistent_state/output/approved',selected_result:{coalesce:['/nodes/adversarial_review/output','/nodes/one_shot_review/output']}},'finalizer');

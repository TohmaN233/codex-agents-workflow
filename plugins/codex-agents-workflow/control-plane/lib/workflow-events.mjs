...
export const EVENT_KINDS = new Set(['generation_repair', 'started', 'claim', 'complete', 'fail', 'retry', 'cancel', 'pause', 'resume', 'approve', 'dispatch_intent', 'dispatch_receipt', 'executor_event', 'recover', 'control_recovery', 'child_intent', 'child_started']);

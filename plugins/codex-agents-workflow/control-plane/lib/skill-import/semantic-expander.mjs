...
export async function applyExpansion(store, workflowId, proposal, { expected_revision, context = {}, inference_confirmation = null, conversion_review_contract_version }) {
  ...
  const certificate=createConversionCertificate(compiled.workflow,resources,{source_revision:pack.revision_hash,proposal_hash:compiled.proposal_hash,review_contract_version:conversion_review_contract_version});

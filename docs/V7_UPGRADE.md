...
the Codex Agents Workflow console through `codex_agents_workflow_console` or the existing one-click scripts.
...
Maintainer checks: `node plugins/codex-agents-workflow/control-plane/test/run-tests.mjs`,
